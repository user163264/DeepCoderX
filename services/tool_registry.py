...
class ToolRegistry:
    ...
    def list_tools(self, category: Optional[ToolCategory] = None, 
        ...
        """List tools, optionally filtered by category or permission."""
    ...
    def get_openai_definitions(self, categories: Optional[List[ToolCategory]] = None,
    ...
    def _register_core_tools(self) -> None:
        ...
        # ENHANCED DIRECTORY OPERATIONS - OpenAPI 3.1 MCP Compliance
        self.register_tool(ToolDefinition(
            name="mkdir",
