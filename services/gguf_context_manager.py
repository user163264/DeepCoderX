...
class GGUFContextManager:
    ...
    def __init__(self, provider_name: str = "local", session_dir: Path = None):
        ...
        # Context management settings - Adjusted for 4096 context window
        self.max_context_tokens = 3000  # Much more conservative limit to prevent overflow
        self.max_history_messages = 10  # Reduced message count for better context management
        self.tokens_per_char = 0.30  # More conservative token estimation
    ...
    def add_tool_message(self, content: str) -> None:
        """Add a tool message to the conversation (for combined tool results)."""
        import time
