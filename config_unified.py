...
class DeepCoderXConfig:
    ...
    def _validate_configuration(self):
        ...
        if self.DEEPSEEK_API_KEY and not re.match(r'^sk-[a-zA-Z0-9]{24}$', self.DEEPSEEK_API_KEY):
            errors.append("Invalid DeepSeek API key format (should be sk-XXXXXXXXXXXXXXXXXXXXXXXX)")
